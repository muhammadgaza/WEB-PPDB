...
<br>
    ...
    <table width="50%" border="0" style="margin-left:3%;margin-right:2%;float:left">
        ...
        <tr>
            ...
            <td width="3%">:</td>
            <td>22 Desember 2022 19:46:44</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td width="3%">:</td>
            <td>{{$student->phone_number_ayah}}</td>
        </tr>
        <tr>
            <td width="30%" style="font-size: 13px"><b>NO HP Ibu</b></td>
            <td width="3%">:</td>
            <td>{{$student->phone_number_ibu}}</td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="3">Username :{{$student->email}}</td>
        </tr>
        <tr>
      
            <td colspan="3">Password :{{$student->NISN}}</td>
        </tr>
        <tr>
